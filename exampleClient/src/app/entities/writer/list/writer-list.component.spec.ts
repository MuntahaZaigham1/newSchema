...
import { IWriter, WriterService, WriterDetailsComponent, WriterListComponent,
	WriterNewComponent } from '../';
...
describe('WriterListComponent', () => {
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'writer/:id', component: WriterDetailsComponent }
          ])
        ],
        providers: [
          WriterService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/writer/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
