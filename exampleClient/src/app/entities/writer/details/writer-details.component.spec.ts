...
import { IWriter, WriterService, WriterDetailsComponent, WriterListComponent } from '../';
...
describe('WriterDetailsComponent', () => {
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'writer', component: WriterDetailsComponent },
            { path: 'writer/:id', component: WriterListComponent }
          ])
        ],
        providers: [
          WriterService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/writer');
