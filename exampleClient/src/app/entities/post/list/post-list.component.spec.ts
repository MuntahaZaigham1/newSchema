...
import { IPost, PostService, PostDetailsComponent, PostListComponent,
	PostNewComponent } from '../';
...
describe('PostListComponent', () => {
  ...
  let constData:IPost[] = [
    {   
      ...
      id: 1,
      title: 'title1',
      writerDescriptiveField: 1,
    },
    {   
      body: 'body2',
      id: 2,
      title: 'title2',
      writerDescriptiveField: 2,
    },
  ];
  let data: IPost[] = [... constData];
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/post/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
